...
Matrix4x4 WorldTransformUtil::Multiply(Matrix4x4 matrix1, Matrix4x4 matrix2) {
...
Matrix4x4 WorldTransformUtil::MakeAffineMatrix(Vector3& scale, Vector3& rotate, Vector3& translate) { 
	//====================
	// 拡縮の行列の作成
	//====================
...
void WorldTransformUtil::WorldTransformUpdate(WorldTransform& worldTransform) {
